...
\address{Creek Road, Deptford,}{SE8 3FD, UK.}% optional, remove / comment the line if not wanted; the "postcode city" and and "country" arguments can be omitted or provided empty
%\mobile{+447817479003}                          % optional
%\phone{+2~(345)~678~901}                           % optional
%\fax{+3~(456)~789~012}                             % optional
\email{jameshoweeee@gmail.com}                           % optional
